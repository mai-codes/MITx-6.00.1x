...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in upper_letters:
            if (ord(i) + shift - 65) < 26:
                shift_dict[i] = chr(ord(i) + shift)
            elif (ord(i) + shift - 65) >= 26:
                shift_dict[i] = chr(ord(i) + shift - 26)
        
        for i in lower_letters:
            if (ord(i) + shift - 97) < 26:
                shift_dict[i] = chr(ord(i) + shift)
            elif (ord(i) + shift - 97) >= 26:
                shift_dict[i] = chr(ord(i) + shift - 26)
...
def decrypt_story():
    sample_story = CiphertextMessage(get_story_string())
    return sample_story.decrypt_message()
